...
describe('XML Parser', () => {
  ...
  it('handles valid XML `company` presskit string', () => {
    const result = parseXML(companyXML)
  ...
  it('handles valid XML `product` or `game` presskit string', () => {
    const result = parseXML(productXML)
